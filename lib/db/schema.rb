...
# than a specific node, by foreign key.
#
...
# same type within the same network. This is so that events that refer
...
# need to combine it with a network_id (specified by the scenario's network,
# or a subnetwork of that).
#
...
create_table? :nodes do
  # This network_id is the id of the network to which the node belongs. This is
  # ID changes when pasting the node into a different network. Serialized in xml
  # implicitly using the hierarchy.
  foreign_key :network_id, :networks, :null => false
